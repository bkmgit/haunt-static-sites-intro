...
## Episode: [Introduction](../episodes/introduction.Rmd)
...
(at the end of the [Introduction](../episodes/introduction.Rmd) episode) should remember to add the 
...
## Episode: [Authoring With Markdown](../episodes/markdown.Rmd)
...
## Episode: [Hosting Websites on GitHub](../episodes/github-pages.Rmd)
...
## Episode: [Starting With Jekyll](../episodes/starting-jekyll.Rmd)

## Episode: [Reusing Blocks of Content](../episodes/includes.Rmd)

### `includes` vs `include`
Learners sometimes get confused about when to use `includes` vs `include` in the 
[Reusing Blocks of Content](../episodes/includes.Rmd) episode. Good to stress that the folder is `_includes` 
...
## Episode: [Page Layouts](../episodes/layouts.Rmd)
...
## Episode: [Working With Filters](../episodes/filters.Rmd)

## Episode: [Loops and Collections](../episodes/arrays.Rmd)

## Episode: [Wrap-up](../episodes/wrap-up.Rmd)
